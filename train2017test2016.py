...
corpus2017 = pd.read_excel("C:/Users/jlu39/Desktop/2017 Master Notes Data. ED, Admission Notes. 8.20.xlsx",
                           sheet_name="ED, H&P Notes Only",
                           header=0,
                           usecols="D,T,X")
corpus2016 = pd.read_excel("C:/Users/jlu39/Desktop/2016 Master Notes Data. ED, Admission Notes. 9.9.20.xlsx",
                           sheet_name="ED, H&P Notes Only",
                           header=0,
                           usecols="D,K,O")
...
list_of_ids = df2016['enc_id'].tolist()
...
number of times a word appear in a given sentence
-- log to the base e of number of the total documents divided by the documents in which the word appears.
...
print("SVM Accuracy Score from built-in library->", accuracy_score(predictions_SVM, Test_Y) * 100)
